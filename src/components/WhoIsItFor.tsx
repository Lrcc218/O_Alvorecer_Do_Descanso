      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16 md:mb-20">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl tracking-tight leading-tight text-[#262626] font-light">
            Para quem é o <span className="italic font-normal" style={{ color: "var(--gold)" }}>Alvorecer do Descanso?</span>
          </h2>
        </div>
          ...
          >
            ...
            <ul className="space-y-6">
              {[
                ...
                <li key={i} className="flex items-start gap-4 text-[#262626]/80 font-sans text-base lg:text-lg font-light leading-relaxed">
          ...
          >
            ...
            <ul className="space-y-6">
              {[
                ...
                <li key={i} className="flex items-start gap-4 text-[#262626]/60 font-sans text-base lg:text-lg font-light leading-relaxed">
