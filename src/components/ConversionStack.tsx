...
const CARDS: CardData[] = [
  ...
  },
  {
    ...
    list: ["Fisioterapia Ilustrada", "Exemplos Reais Gravados", "Ideal para os primeiros 4 meses"],
  ...
  },
  {
    ...
    list: ["Guia de Exposição de Luz", "Configuração de Ruído Branco", "Controle Térmico"],
