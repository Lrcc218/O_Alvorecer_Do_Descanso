...
const SPACING_DICTIONARY: Record<SpacingType, string> = {
  default: "mb-12 md:mb-16", // Ritmo padronizado
  large: "mb-12 md:mb-16", // Ritmo padronizado (igualado para manter proporção)
  none: "mb-0",
};
...
const HERO_BLOCKS: TextBlock[] = [
  ...
  },
  {
    ...
    content: (
      <>
        Você está sentada no escuro, sentindo um peso que não é apenas físico, mas um cansaço que
        dói na alma. E a maldita dúvida sussurra no seu ouvido:{" "}
  ...
  },
  {
    ...
    className:
      "font-serif text-2xl md:text-3xl lg:text-4xl 2xl:text-5xl italic leading-snug text-center max-w-[780px] 2xl:max-w-[1100px] mx-auto",
...
const SALES_CONTENT: TextBlock[] = [
  ...
  },
  {
    ...
    content: (
      <strong className="font-serif italic text-xl md:text-2xl lg:text-3xl 2xl:text-4xl font-normal leading-relaxed text-[#2C1A04] block tracking-wide">
        A ciência comprova: a falta de sono destrói a região do cérebro materno responsável pela
        regulação emocional.
      </strong>
    ),
    className:
      "bg-[#F5E6C4]/30 border-l-4 border-[#D4AF37] shadow-[0_12px_40px_rgba(212,175,55,0.06)] pt-8 pb-8 pl-8 pr-6 md:pt-10 md:pb-10 md:pl-12 md:pr-10 mx-auto max-w-[750px] 2xl:max-w-[1000px] rounded-xl text-center lg:mx-auto",
  },
  {
    id: "block-6",
    type: "p",
  ...
  },
  {
    ...
    spacing: "default",
    content:
      "Você já percebeu que quanto mais exausta você está, mais o seu bebê briga com o sono?",
    className:
      "font-serif font-semibold text-center text-xl md:text-2xl lg:text-3xl 2xl:text-4xl max-w-[780px] 2xl:max-w-[1050px] mx-auto lg:mx-auto",
  },
  {
    id: "block-8",
    type: "p",
    ...
    className:
      "font-sans text-center font-medium tracking-[0.25em] uppercase text-sm md:text-base mx-auto lg:mx-auto",
    style: { color: "var(--terracotta)" },
  },
  {
    id: "block-9",
  ...
  },
  {
    ...
    spacing: "large",
    content:
      "Para salvar o sono do seu filho, você precisa, primeiro, resgatar o seu direito de respirar.",
    className:
      "font-serif text-2xl md:text-3xl lg:text-4xl 2xl:text-5xl italic leading-snug text-center max-w-[780px] 2xl:max-w-[1050px] mx-auto lg:mx-auto",
    style: { color: "var(--terracotta)" },
  },
  {
    id: "block-11",
    ...
    content: (
      <>
        Para resolver isso, você poderia buscar uma consultoria de sono individual ou passar por
        avaliações médicas de ponta, que no mercado atual não custam menos do que{" "}
        <strong className="font-semibold">R$ 400,00 a R$ 800,00</strong> por uma única hora de
        orientação.
      </>
    ),
    className:
  ...
  },
  {
    ...
    content: (
      <>
        O guia completo <strong className="font-semibold">O Alvorecer do Descanso</strong> condensa
        os maiores estudos clínicos de neurociência do sono e desenvolvimento socioemocional em um
        passo a passo prático de aplicação imediata.
      </>
    ),
    className:
      "font-sans text-lg md:text-xl 2xl:text-2xl leading-relaxed tracking-wide text-center max-w-[750px] 2xl:max-w-[68ch] mx-auto lg:mx-auto",
  },
  {
    ...
    content: (
      <>
        ...
        <strong className="font-semibold">Protocolo de Emergência da Madrugada</strong> e as tabelas
        completas de monitoramento em qualidade máxima (2K) prontas para impressão.
      </>
    ),
    className:
      "font-sans text-lg md:text-xl 2xl:text-2xl leading-relaxed tracking-wide text-center max-w-[750px] 2xl:max-w-[68ch] mx-auto lg:mx-auto",
  },
  {
    ...
    content: (
      <>
        O acesso a esse manual definitivo de sobrevivência e restauração da sua saúde mental deveria
        custar, pelo menos, <span className="line-through opacity-60">R$ 197,00</span>.
      </>
    ),
    className:
      "font-sans text-lg md:text-xl 2xl:text-2xl leading-relaxed tracking-wide text-center max-w-[750px] 2xl:max-w-[68ch] mx-auto lg:mx-auto",
  ...
  },
  {
    ...
    content: (
      <>
        Por isso, apenas hoje, você pode garantir o guia completo e todas as ferramentas de
        aplicação imediata por um pagamento único de <strong className="font-bold">R$ 67,90</strong>{" "}
        ou <strong className="font-bold">6x de R$ 11,31</strong>.
      </>
    ),
    className:
      "font-serif text-2xl md:text-3xl lg:text-4xl 2xl:text-5xl leading-snug text-center font-medium max-w-[800px] 2xl:max-w-[1050px] mx-auto lg:mx-auto",
    style: { color: "var(--terracotta)" },
  },
  {
    id: "block-18",
    ...
    className:
      "font-serif italic text-center text-lg md:text-xl 2xl:text-2xl opacity-80 max-w-[700px] 2xl:max-w-[950px] mx-auto lg:mx-auto",
  },
  {
    id: "block-19",
    type: "p",
    ...
    <>
      ...
      >
        <div className="relative mx-auto w-full flex flex-col">
          {/* Hero Manifesto Copy */}
          <div className="max-w-[1000px] lg:max-w-none 2xl:max-w-[1400px] mx-auto w-full px-[clamp(1rem,4vw,1.5rem)] flex flex-col items-center text-center [contain:layout] mb-32 md:mb-48">
            <div className="w-full flex flex-col items-center text-center subpixel-antialiased [text-rendering:optimizeLegibility]">
          ...
          <div className="max-w-[1200px] md:max-w-none 2xl:max-w-screen-2xl mx-auto w-full px-[clamp(1rem,4vw,1.5rem)] grid grid-cols-1 md:grid-cols-12 md:gap-10 lg:gap-16 2xl:gap-24">
            ...
            <div
              className="md:col-span-7 flex flex-col items-center text-center text-[#262626]"
              ref={(el) => {
                if (el && !el.getAttribute("data-passive")) {
                  el.addEventListener("touchstart", () => {}, { passive: true });
                  el.setAttribute("data-passive", "true");
                ...
                <div className="space-y-3 2xl:space-y-5">
                  ...
                  <div className="bg-[#F5E6C4]/25 border border-[#D4AF37]/20 rounded-2xl p-4 lg:p-5 2xl:p-6 backdrop-blur-sm shadow-xl">
                    ...
                    <p className="font-serif text-base lg:text-lg 2xl:text-xl italic text-[#262626]/80 leading-relaxed mb-3 2xl:mb-4">
                      &ldquo;A ciência comprova: a falta de sono destrói a região do cérebro materno
                      responsável pela regulação emocional.&rdquo;
                    </p>
                    ...
                    <div className="w-full h-8 2xl:h-10 rounded-lg bg-white/20 border border-white/60 flex items-center justify-center overflow-hidden mb-3 2xl:mb-4">
                      ...
                      >
                        <path
                          d="M0,15 C10,5 20,25 30,15 C40,5 50,25 60,15 C70,5 80,25 90,15 C100,5 110,25 120,15 C130,5 140,25 150,15 C160,5 170,25 180,15 C190,5 200,25 200,15"
                          fill="none"
                          stroke="#D4AF37"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                  ...
                  <div className="bg-[#F5E6C4]/25 border border-[#D4AF37]/20 rounded-2xl p-4 lg:p-4 2xl:p-6 backdrop-blur-sm shadow-xl flex flex-col justify-between">
                    <div className="flex gap-4 lg:gap-4 items-center mb-3 2xl:mb-4">
                      <div className="w-[85px] lg:w-[100px] 2xl:w-[130px] shrink-0 aspect-[3/4] bg-white/30 rounded-xl flex items-center justify-center border border-white/60 shadow-sm relative overflow-hidden [backface-visibility:hidden]">
                        ...
                        <span className="font-serif italic text-xs lg:text-sm 2xl:text-base text-[#262626]/80 font-medium z-0 text-center px-2">
                          Capa do Produto
                        </span>
                      </div>
                      <ul className="flex-1 space-y-2 lg:space-y-2.5 2xl:space-y-3">
                        <li className="flex items-start gap-2 text-[#262626]">
                          <svg
                            ...
                            className="w-4 h-4 2xl:w-5 2xl:h-5 shrink-0 mt-0.5"
                            style={{ color: "var(--terracotta)" }}
                          >
                            <path d="M20 6 9 17l-5-5" />
                          </svg>
                          <span className="font-sans text-[11px] lg:text-xs 2xl:text-sm leading-tight text-[#262626]/90 font-medium">
                            O exato método para regular o relógio biológico
                          </span>
                        </li>
                        <li className="flex items-start gap-2 text-[#262626]">
                          <svg
                          ...
                          <span className="font-sans text-[11px] lg:text-xs 2xl:text-sm leading-tight text-[#262626]/90 font-medium">
                            <strong className="font-semibold text-black">Tabela Mestra</strong> de
                            Janelas de Sono
                          </span>
                        </li>
                        <li className="flex items-start gap-2 text-[#262626]">
                        ...
                        <li className="flex items-start gap-2 text-[#262626]">
                          ...
                          <span className="font-sans text-[11px] lg:text-xs 2xl:text-sm leading-tight text-[#262626]/90 font-medium">
                            Tabelas de monitoramento prontas para impressão
                          </span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="text-center mb-3 2xl:mb-4">
                      <p className="font-sans text-xs 2xl:text-sm opacity-60 line-through mb-0.5">
                        R$ 197,00
                      </p>
                      <p
                        className="font-serif text-3xl lg:text-4xl 2xl:text-5xl font-bold mb-0.5 tracking-tight"
                        style={{ color: "var(--terracotta)" }}
                      >
                        R$ 67,90
                      </p>
                      <p className="font-sans text-xs 2xl:text-sm font-medium opacity-80">
                        ou 6x de R$ 11,31
                      </p>
                    </div>
                    ...
                    >
                      ...
                      <span className="uppercase tracking-wide leading-tight text-center font-sans">
          ...
          {/* Bloco de Garantia Blindada (Visível no fluxo principal) */}
          <div className="max-w-[1200px] mx-auto w-full px-4 mb-12">
            <GuaranteeBlock />
          </div>

          {/* Mobile-only CTA (visible on small screens where sidebar is hidden) */}
          <div className="md:hidden max-w-[750px] mx-auto w-full px-[clamp(1rem,4vw,1.5rem)] mt-10">
            <div className="text-center mb-6">
              <p className="font-sans text-sm opacity-60 line-through mb-1">R$ 197,00</p>
              <p
                className="font-serif text-4xl font-bold mb-1 tracking-tight"
                style={{ color: "var(--terracotta)" }}
              >
                R$ 67,90
              </p>
